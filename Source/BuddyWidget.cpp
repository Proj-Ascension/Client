...
*/
BuddyWidget::BuddyWidget(const QPixmap &icon, const QString &name, const QString &text,
...
*/
void BuddyWidget::enterEvent(QEvent* event)
{
    Q_EMIT hovered();
...
*/
void BuddyWidget::leaveEvent(QEvent* event)
{
    Q_EMIT unhovered();
...
*/
void BuddyWidget::mousePressEvent(QMouseEvent* event)
{
    Q_EMIT clicked();
...
*/
void BuddyWidget::paintEvent(QPaintEvent* event)
{
    // Default paint event
...
*/
void BuddyWidget::toggleHovered()
{
    if (!isActive)
    {
        animation->stop();
...
*/
void BuddyWidget::toggleUnhovered()
{
    if (!isActive)
    {
        animation->stop();
...
*/
void BuddyWidget::toggleActive()
{
    isActive = true;
    this->setStyleSheet("BuddyWidget#" + this->objectName() +
...
*/
void BuddyWidget::toggleInactive()
{
    isActive = false;
